    ...
    answer: [
      {
        ...
        img: "./assets/question-4/power-icon.jpg",
      },
      {
        answer_id: 2,
        text: "Settings icon",
        img: "./assets/question-4/setting-icon.jpg",
      },
      {
        answer_id: 3,
        text: "File Explorer icon",
        img: "./assets/question-4/file-icon.jpg",
      },
      {
        answer_id: 4,
        text: "All App icon",
        img: "./assets/question-4/app-icon.jpg", 
      },
    ],
    image: null,
  },
    ...
    answer: [
      {
        answer_id: 1,
        text: "Keyboard",
        img: "./assets/question-8/keyboard.jpg",
      },
      {
        answer_id: 2,
        text: "Headphone",
        img: "./assets/question-8/headphones.png",
      },
      {
        answer_id: 3,
        text: "Webcam",
        img: "./assets/question-8/camera.jpg",
      },
      {
        answer_id: 4,
        text: "Mouse",
        img: "./assets/question-8/mouse.jpg",
      },
    ],
    image: null,
  },
    ...
    answer: [
      {
        answer_id: 1,
        text: "User icon",
        img: "./assets/question-14/user-icon.jpg",
      },
      {
        answer_id: 2,
        text: "Windows icon",
      ...
      },
      {
        answer_id: 3,
        text: "Settings icon",
        img: "./assets/question-14/setting-icon.jpg",
      },
      {
        answer_id: 4,
        text: "Power icon",
        img: "./assets/question-14/power-icon.jpg",
      },
    ],
    image: null,
  },
